...
class MostAffectedWidget extends StatelessWidget {
  ...
  const MostAffectedWidget({Key key, this.countryData}) : super(key: key);
        ...
        return Container(
          ...
          child: Row(
             ...
             children: <Widget>[
               ...
               SizedBox(width: 10,),
               Text('Deaths: ${countryData[index]['deaths']}',style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),)
             ],
          ),
